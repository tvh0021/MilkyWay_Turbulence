"""
Script to compute the velocity structure function (VSF) of the CGM in the M87 simulation, using yt to regrid the data
and numba for parallelization. The VSF is computed as the mean velocity difference between pairs of points in the CGM
as a function of their separation distance. The VSF_3D function implemented here is the fastest implementation I have
found after experimenting with various approaches.
"""
